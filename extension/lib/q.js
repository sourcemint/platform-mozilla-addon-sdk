// NOTE: This is taken from `../support/kriskowal-q/q.js` with some modifications.
// NOTE: We require the `event-queue` module using a string literal so that the
//		 addon-on SDK dependency parser will authorize our dynamic require below.
// @see https://github.com/kriskowal/q/issues/44
// TODO: Auto-patch `support/kriskowal-q/q.js` and write to here on every `build`.
require("event-queue");
